...
=====================================================================
Amazon Transcribe × AWS Glue DataBrew で日本語音声ファイルの文字起こしとマスキングを実装してみた
=====================================================================
* `詳細 <https://qiita.com/tyskJ/items/2168b44d1d005683d1ea>`_
...
.. code-block:: bash
  ...
  SYSTEM="aws-transcribe-pii-reduction-by-glue-databrew"
...
.. code-block:: bash
  ...
  cat <<EOF > event.json
  {
    ...
    "outputKey": "pii_include.wav",
  
    "engine": "neural",
    "sampleRate": 16000,
    "gapMs": 450,
    "targetWavBytes": 2097152,
